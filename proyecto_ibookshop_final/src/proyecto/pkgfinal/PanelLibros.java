...
int cont2;
    ...
    public PanelLibros() {
        ...
        p.addColumn("Libro");
        p.addColumn("Autor");
        p.addColumn("Fecha de Publicacion");
        p.addColumn("Editorial");
        p.addColumn("Precio");
    }
    
   public void OPmostrar_libros(ArrayList<Class_Libro> libro){
       cont2 = 0;
       for (Class_Libro libros : libro){
           String [] fila = new String[6];
           fila[0] = String.valueOf(cont2);
           fila[1] = libros.get_Titulo_Libro();
           fila[2] = libros.get_Autor_Libro();
           fila[3] = libros.get_Fecha_libro();
           fila[4] = libros.get_Editorial_Libro();
           fila[5] = String.valueOf(libros.get_Precio_Libro());
           
           p.addRow(fila);
                   
       }
       tabla_libros.setModel(p);
   }
    ...
    private void initComponents() {
        ...
        tabla_libros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Numero", "Libros", "Autor", "Fecha de Publicacion", "Editorial", "Precio"
            }
        ));
